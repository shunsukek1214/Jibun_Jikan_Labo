...
"[project]/app/listening/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ListeningPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ListeningPage.useEffect": ()=>{
            navigator.mediaDevices.getUserMedia({
                audio: true
            }).then({
                "ListeningPage.useEffect": (stream)=>{
                    const rec = new MediaRecorder(stream);
                    rec.ondataavailable = ({
                        "ListeningPage.useEffect": (e)=>chunksRef.current.push(e.data)
                    })["ListeningPage.useEffect"]; // 音声のかけらを貯める
                    rec.start();
                    recorderRef.current = rec;
                }
            }["ListeningPage.useEffect"]).catch({
                "ListeningPage.useEffect": ()=>{
            ...
            return ({
                "ListeningPage.useEffect": ()=>{
                    recorderRef.current?.stream.getTracks().forEach({
                        "ListeningPage.useEffect": (t)=>t.stop()
                    }["ListeningPage.useEffect"]);
                }
            })["ListeningPage.useEffect"];
        }
    ...
    const finish = ()=>{
        ...
        if (rec && rec.state !== 'inactive') {
            rec.onstop = ()=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendUtterance"])(audio); // バックエンドへ（未接続でも止まらない）
...
_s(ListeningPage, "UhTo++Ik/PjQlLj4+KyV7u5MNyE=", false, function() {
    return [
...
_c = ListeningPage;
var _c;
__turbopack_context__.k.register(_c, "ListeningPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_09edi81._.js.map